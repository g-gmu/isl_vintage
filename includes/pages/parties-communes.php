<div class="container">
    <div class="sous-container">
        <div id="zone-titre">
            ...
            <div class="partsall_ln1sm_01 partsall_ln1md_01 partsall_ln1xl_01 titre-imagetitre">                
                <div><?php include './includes/liens/lien-vintage-home-logo.php';  ?></div>                    
                <div>vintage<strong> lab</strong></div>
            </div>
            <div class="partsall_ln1sm_02 partsall_ln1md_02 partsall_ln1xl_02 vide">vide</div>
            <div class="partsall_ln1sm_03 partsall_ln1md_03 partsall_ln1xl_03 titre-bouton">
            ...
            <div class="partsall_ln1sm_04 partsall_ln1md_04 partsall_ln1xl_04 vide">vide</div>
        </div>
    </div>
</div>
<hr>
<div class="container">
    <div class="sous-container">
        ...
        <!--    partsall : balise commune à tous le site             -->
        <div id="zone-menu">
            <div class="partsall_ln2sm_01 partsall_ln2md_01 partsall_ln2xl_01 menu_accueil">
            ...
            <!-- ===============================================================
                    ...
                    des meubles).
                 =============================================================== -->
            <div class="partsall_ln2sm_02 partsall_ln2md_02 partsall_ln2xl_02 menu_meubles">
                <?php include './includes/liens/lien-vintage-meubles.php';  ?>
            </div>
            <div class="partsall_ln2sm_03 partsall_ln2md_03 partsall_ln2xl_03 menu_luminaires">
                <?php include './includes/liens/lien-vintage-luminaires.php';  ?>
            </div>
            <div class="partsall_ln2sm_04 partsall_ln2md_04 partsall_ln2xl_04 menu_accessoires">
                <?php include './includes/liens/lien-vintage-accessoires.php';  ?>
            </div>
            <div class="partsall_ln2sm_05 partsall_ln2md_05 partsall_ln2xl_05 menu_contact">
